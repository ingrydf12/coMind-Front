            ...
            <div className="Sobre-text">
                ...
                <div className="card-container">
                    <div className="card-sobre">
                        <img src="https://github.com/ingrydf12/coMind-Front/blob/main/src/assets/carrosel1.png" alt="carrosel1.png" />
                        <h2>Encontros online diretamente com o médico</h2>

                    </div>
                    <div className="card-sobre">
                        <img src="https://github.com/ingrydf12/coMind-Front/blob/main/src/assets/carrosel2.png" alt="carrosel2.png" />
                        <h2>Acesso a grupo de apoio virtual</h2>

                    </div>
                    <div className="card-sobre">
                        <img src="https://github.com/ingrydf12/coMind-Front/blob/main/src/assets/carrosel3.png" alt="carrosel3.png" />
