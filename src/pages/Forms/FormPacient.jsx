  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await authService.register({
        ...
        genero: form.genero,
        idade: form.idade,
        principaisQueixas: form.principaisQueixas || "",
        usoDeMedicamentos: form.usoDeMedicamentos,
        objetivoDaTerapia: form.objetivoDaTerapia,
    ...
    <form className="form-style" onSubmit={handleSubmit}>
      ...
      <div>
        <div className="personal">
          <div>
            <label className="main-title" htmlFor="nomeCompleto">
              Nome completo
            </label>
            <input
        ...
        <div className="personal">
          ...
          <div>
            <label className="sub-title" htmlFor="idade">
              Idade:
            </label>
            <input
          ...
          <div>
            <label className="sub-title" htmlFor="objetivoDaTerapia">
              Qual o seu objetivo com a terapia?
            </label>
            <textarea
              className="textarea-form"
              onChange={handleChange}
              value={form.objetivoDaTerapia}
              id="objetivoDaTerapia"
      ...
      <div>
        ...
        <div className="service">
          <div>
            <fieldset className="fieldset-form">
              <legend>
                Você faz uso de algum medicamento para a saúde mental?
              </legend>
              <input
                type="radio"
                id="yes"
                ...
                value="SIM"
                onChange={handleChange}
                checked={form.usoDeMedicamentos === "SIM"}
                required
              />
              ...
              <input
                ...
                value="NAO"
                onChange={handleChange}
                checked={form.usoDeMedicamentos === "NAO"}
                required
              />
            ...
            <div>
              <label className="sub-title" htmlFor="principaisQueixas">
                Quais as suas principais queixas?
              </label>
              <textarea
                className="textarea-form"
                onChange={handleChange}
                value={form.principaisQueixas}
            ...
            <div>
              <label className="sub-title" htmlFor="historicoFamiliar">
                Há histórico de doenças da mente na sua família?
              </label>
              <textarea
                className="textarea-form"
                onChange={handleChange}
